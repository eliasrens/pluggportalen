...
> **Testkonto (live):** användarnamn `elev1`, lösenord `123` – **oförändrat före
> och efter** lösenordsmigreringen. elev1 har < 6 tecken, så migreringen kör
> `--short=preserve` (SCRYPT-import) som bevarar det exakta lösenordet `123`
> (se `docs/ADMIN.md`).
